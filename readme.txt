...
　2017年7月現在、「BaseCross」はDx11版につきましてはおおむねまとまってきました。
...
からダウンロードできます。
　使用方法等は各レポジトリを参照ください。ただ2017年夏現在、「DxBase2015、DxBase2016、Fbx2Bin」はメンテナンスを行っておりません。できれば「BaseCross」をご利用ください。
...
　　　　　　　　　　　　　　　　　　　　　2017年新夏　山ノ井　靖（WiZゲーム科非常勤講師：C++担当）
