...
namespace basecross {
	...
	ShadowmapRenderer::ShadowmapRenderer(const shared_ptr<Stage>& StagePtr) :
		GameObject(StagePtr)
	{}
	...
	//--------------------------------------------------------------------------------------
	SimplePCTStaticRenderer::SimplePCTStaticRenderer(const shared_ptr<Stage>& StagePtr) :
	...
	void SimplePCTStaticRenderer::OnCreate() {
		//タグの追加
		AddTag(L"SimplePCTStaticRenderer");
	}
	...
	//--------------------------------------------------------------------------------------
	SimplePNTStaticRenderer::SimplePNTStaticRenderer(const shared_ptr<Stage>& StagePtr) :
		SimpleRenderer(StagePtr)
	{}
	...
	void SimplePNTStaticRenderer::OnCreate() {
		//タグの追加
		AddTag(L"SimplePNTStaticRenderer");
	}
	...
	//--------------------------------------------------------------------------------------
	SimplePNTStaticRenderer2::SimplePNTStaticRenderer2(const shared_ptr<Stage>& StagePtr) :
		SimpleRenderer(StagePtr)
	{}
	...
	void SimplePNTStaticRenderer2::OnCreate() {
		//タグの追加
		AddTag(L"SimplePNTStaticRenderer2");
	}
	...
	//--------------------------------------------------------------------------------------
	SimplePNTStaticModelRenderer::SimplePNTStaticModelRenderer(const shared_ptr<Stage>& StagePtr) :
		SimpleRenderer(StagePtr)
	{}
	...
	void SimplePNTStaticModelRenderer::OnCreate() {
		//タグの追加
		AddTag(L"SimplePNTStaticModelRenderer");
	}
	...
	//--------------------------------------------------------------------------------------
	SimplePNTStaticModelRenderer2::SimplePNTStaticModelRenderer2(const shared_ptr<Stage>& StagePtr) :
		SimpleRenderer(StagePtr)
	{}
	...
	void SimplePNTStaticModelRenderer2::OnCreate() {
		//タグの追加
		AddTag(L"SimplePNTStaticModelRenderer2");
	}
	...
	//--------------------------------------------------------------------------------------
	SimplePNTBoneModelRenderer::SimplePNTBoneModelRenderer(const shared_ptr<Stage>& StagePtr) :
		SimpleRenderer(StagePtr)
	{}
	...
	void SimplePNTBoneModelRenderer::OnCreate() {
		//タグの追加
		AddTag(L"SimplePNTBoneModelRenderer");
	}
	...
	//--------------------------------------------------------------------------------------
	SimplePNTBoneModelRenderer2::SimplePNTBoneModelRenderer2(const shared_ptr<Stage>& StagePtr) :
		SimpleRenderer(StagePtr)
	{}
	...
	void SimplePNTBoneModelRenderer2::OnCreate() {
		//タグの追加
		AddTag(L"SimplePNTBoneModelRenderer2");
	}
	...
	///	BcPNT頂点オブジェクトの描画クラス
	//--------------------------------------------------------------------------------------
	BcPNTStaticRenderer::BcPNTStaticRenderer(const shared_ptr<Stage>& StagePtr) :
		BcRenderer(StagePtr)
	{}
	...
	//--------------------------------------------------------------------------------------
	BcPNTnTStaticRenderer::BcPNTnTStaticRenderer(const shared_ptr<Stage>& StagePtr) :
		BcRenderer(StagePtr)
	{}
	...
	void BcPNTnTStaticRenderer::OnCreate() {
		//タグの追加
		AddTag(L"BcPNTnTStaticRenderer");
	}
	...
	//--------------------------------------------------------------------------------------
	BcPNTStaticModelRenderer::BcPNTStaticModelRenderer(const shared_ptr<Stage>& StagePtr) :
		BcRenderer(StagePtr)
	{}
	...
	void BcPNTStaticModelRenderer::OnCreate() {
		//タグの追加
		AddTag(L"BcPNTStaticModelRenderer");
	}
	...
	//--------------------------------------------------------------------------------------
	BcPNTnTStaticModelRenderer::BcPNTnTStaticModelRenderer(const shared_ptr<Stage>& StagePtr) :
		BcRenderer(StagePtr)
	{}
	...
	void BcPNTnTStaticModelRenderer::OnCreate() {
		//タグの追加
		AddTag(L"BcPNTnTStaticModelRenderer");
	}
	...
	//--------------------------------------------------------------------------------------
	BcPNTBoneModelRenderer::BcPNTBoneModelRenderer(const shared_ptr<Stage>& StagePtr) :
		BcRenderer(StagePtr)
	{}
	...
	void BcPNTBoneModelRenderer::OnCreate() {
		//タグの追加
		AddTag(L"BcPNTBoneModelRenderer");
	}
	...
	//--------------------------------------------------------------------------------------
	BcPNTnTBoneModelRenderer::BcPNTnTBoneModelRenderer(const shared_ptr<Stage>& StagePtr) :
		BcRenderer(StagePtr)
	{}
	...
	void BcPNTnTBoneModelRenderer::OnCreate() {
		//タグの追加
		AddTag(L"BcPNTnTBoneModelRenderer");
	}
